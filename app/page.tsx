            ...
            <main className="w-full max-w-[1280px] min-h-[800px] bg-white dark:bg-slate-900 shadow-2xl rounded-2xl flex flex-col overflow-hidden border border-slate-200 dark:border-slate-800 transition-all duration-500">
                ...
                <div className="flex-1 flex flex-col lg:flex-row gap-8 p-8 overflow-hidden">
                    ...
                    <div className="flex-[3] flex flex-col gap-6">
                        <div className="bg-slate-50 dark:bg-slate-950/30 rounded-2xl p-8 flex-1 flex flex-col border border-slate-100 dark:border-slate-800 shadow-sm">
                        ...
                        {/* Secondary View: Scrap/Logs Preview */}
                        <div className="grid grid-cols-2 gap-6">
                            <div className="bg-slate-50 dark:bg-slate-950/30 rounded-2xl p-6 border border-slate-100 dark:border-slate-800 flex items-center justify-between group hover:bg-white dark:hover:bg-slate-800 transition-all cursor-pointer">
                                <div>
                    ...
                    <div className="flex-[2] flex flex-col gap-6">
                        ...
                        {/* Recent Registers Widget */}
                        <div className="bg-slate-50 dark:bg-slate-950/30 rounded-2xl p-6 border border-slate-100 dark:border-slate-800 flex-1 flex flex-col">
                        ...
                        {/* Uptime Widget */}
                        <div className="bg-slate-50 dark:bg-slate-950/30 rounded-2xl p-6 border border-slate-100 dark:border-slate-800">
